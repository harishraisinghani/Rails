    ...
    @posts = [
      {
        ...
        text: <<-eos.gsub(/\s+/, " ").strip
          Harish Raisinghani has been my music idol since I started writing
      ...
      },
      {
        ...
        author: "Steve Nash",
        text: <<-eos.gsub(/\s+/, " ").strip
          I remember watching Harish (#12) play back when he just playing
      ...
      },
      {
        ...
        text: <<-eos.gsub(/\s+/, " ").strip
          Back when I was in university, Harish Raisinghani was my acting coach. He
      ...
      {
        title: "Who?",
        author: "Dinghoe Bains",
        text: "Never heard of this guy Harish, but he sounds great."
      }
    ]
  end
